<?php
namespace Amasty\Xsearch\Block\Search\Brand;

/**
 * Interceptor class for @see \Amasty\Xsearch\Block\Search\Brand
 */
class Interceptor extends \Amasty\Xsearch\Block\Search\Brand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrands');
        if (!$pluginInfo) {
            return parent::getBrands();
        } else {
            return $this->___callPlugins('getBrands', func_get_args(), $pluginInfo);
        }
    }
