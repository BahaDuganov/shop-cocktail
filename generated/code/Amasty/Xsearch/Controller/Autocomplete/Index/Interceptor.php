...
class Interceptor extends \Amasty\Xsearch\Controller\Autocomplete\Index implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $storeManager, $queryFactory, $layerResolver, $resultJsonFactory, $layoutFactory, $coreRegistry, $helper, $urlDecoder, $urlHelper, $searchHelper, $scopeConfig, $formKeyValidator);
    }
