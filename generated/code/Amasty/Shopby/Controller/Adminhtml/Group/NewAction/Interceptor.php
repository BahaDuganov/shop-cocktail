<?php
namespace Amasty\Shopby\Controller\Adminhtml\Group\NewAction;

/**
 * Interceptor class for @see \Amasty\Shopby\Controller\Adminhtml\Group\NewAction
 */
class Interceptor extends \Amasty\Shopby\Controller\Adminhtml\Group\NewAction implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $coreRegistry, $resultPageFactory, $groupAttrFactory, $groupAttrRepository, $sessionFactory, $typeList, $resultForwardFactory);
    }
