define(['Mirasvit_Core/js/lib/moment','Mirasvit_Core/js/lib/later'],function(moment){'use strict';var numberList=function(numbers){if(numbers.length<2){return moment()._locale.ordinal(numbers);}
