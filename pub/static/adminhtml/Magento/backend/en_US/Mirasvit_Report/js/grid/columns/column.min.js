define(['Magento_Ui/js/grid/columns/column','uiRegistry'],function(Column){'use strict';return Column.extend({defaults:{bodyTmpl:'report/grid/cells/column'},getComparisonLabel:function(record){if(record['c|'+this.index]!==undefined){return record['c|'+this.index];}
