define(['./abstract','jquery','underscore'],function(Abstract,$,_){return Abstract.extend({getChartConfig:function(){return{type:'doughnut',options:{title:{display:false},legend:{display:false},responsive:true,maintainAspectRatio:false}};},updateData:function(){if(!this.chart){return;}
