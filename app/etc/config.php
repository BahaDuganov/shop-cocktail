...
return [
    'modules' => [
        ...
        'Aislend_Alert' => 0,
        'Aislend_Bottlecart' => 0,
        'Aislend_Cart' => 0,
        'Aislend_Checkout' => 0,
        'Aislend_Configurable' => 0,
        'Aislend_CustomReports' => 0,
        'Aislend_Customer' => 0,
        'Aislend_Custometa' => 0,
        'Aislend_Description' => 0,
        'Aislend_GuestToCustomer' => 0,
        'Aislend_Instruction' => 0,
        'Aislend_OrderManager' => 0,
        'Aislend_Ordermail' => 0,
        'Aislend_ProductAttribute' => 0,
        'Aislend_Recipe' => 0,
        'Aislend_Ribbon' => 0,
        'Aislend_Sales' => 0,
        'Aislend_Tookan' => 0,
        ...
        'Amasty_Storelocator' => 0,
        'Amasty_StorelocatorIndexer' => 0,
        'Amasty_Xsearch' => 1,
        'Amazon_Core' => 0,
        'Amazon_Login' => 0,
        'Amazon_Payment' => 0,
        'Apptrian_ImageOptimizer' => 0,
        'Bss_CheckoutCustomField' => 0,
        'Cadence_Fbpixel' => 0,
        'Codazon_AjaxLayeredNavPro' => 0,
        'Codazon_Core' => 1,
        'Codazon_GoogleAmpManager' => 1,
        'Codazon_Lookbookpro' => 0,
        'Codazon_MegaMenu' => 1,
        'Codazon_ProductFilter' => 1,
        'Codazon_ProductLabel' => 1,
        'Codazon_QuickShop' => 1,
        'Codazon_ShippingCostCalculator' => 0,
        ...
        'Klarna_Kp' => 0,
        'LizardMedia_VarnishWarmer' => 1,
        'MDN_Newsletter' => 0,
        'MagePal_GmailSmtpApp' => 0,
        'MagePal_GoogleTagManager' => 0,
        'MagePsycho_Easypathhints' => 0,
        'MageWorx_AlsoBought' => 0,
        ...
        'Mageplaza_AutoRelated' => 0,
        'Mageplaza_FrequentlyBought' => 0,
        'Mageplaza_Smtp' => 1,
        'Mageplaza_SocialLogin' => 1,
        'Magestore_Sociallogin' => 0,
        'Magetop_DeliveryTime' => 0,
        'Mirasvit_Core' => 1,
        ...
        'Vsourz_OrderSuccess' => 0,
        'WeSupply_Toolbox' => 0,
        'WebShopApps_MatrixRate' => 1,
        'Webkul_DistanceRateShipping' => 1,
        'Webkul_TimeSlotDelivery' => 0,
        'WeltPixel_Backend' => 0,
