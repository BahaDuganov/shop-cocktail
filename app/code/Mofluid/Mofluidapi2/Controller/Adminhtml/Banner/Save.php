...
class Save extends \Magento\Backend\App\Action
{
	...
	public function execute()
    {
        ...
        if($new_mofluid_banner_action_type == "2") {
				...
				$product_ty = $this->_objectManager->get('Magento\Catalog\Model\Product')->load($mofluid_new_banner_action_data_base_id); 
				...
				$cat_ty = $this->_objectManager->get('Magento\Catalog\Model\Category')->load($mofluid_new_banner_action_data_base_id); 
				$name = $cat_ty->getName();
        ...
        if ($data) {
            ...
            if ($id) {
                ...
                $model->setMofluidImagePosition($data['mofluid_image_position']);
				...
				$image_data = array(
					  ...
					  "mofluid_image_position" => $data['mofluid_image_position'],
