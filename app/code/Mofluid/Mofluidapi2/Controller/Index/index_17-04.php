...
class Index extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
		...
		$new_address = $request->getParam("newaddress"); 
                ...
                $res = $this->helper->ws_PrepareCart($cartproducts, $cartaddress, $city_id, $inv_store, $payment_method, $shipping_date, $shipping_carrier_code, $shipping_method_code, $cartregion_id, $customer_id, $email, $cartsession_id, $store_credit, $delivery_date, $slot_time, $slot_id, $slot_group);
            } elseif ($service == "createorderfromcart") {
                $res = $this->helper->ws_createOrderFromCart($order_payload, $cartregion_id, $store, $currency, $customer_id, $cartsession_id, $comment, $shippingDate, $isSubscribe, $delivery_type, $delivery_date, $stripe_token, $email, $save_card, $isNew_card);
			...
			$res = $this->helper->mySavedCard($isloggedIn, $customer_id);
			}
