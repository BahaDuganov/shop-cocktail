...
//                    $script .= '<link id="cdz-maincontent-css" rel="stylesheet" type="text/css"  media="all" href="' .$this->getMainContentCssFile(). '" />'."\n";
                    $script .= '<link id="cdz-maincontent-css" rel="stylesheet" type="text/css"  media="all" href="' . $this->getMediaUrl('codazon/themelayout/main/main-content-style10/custom-main.css') . '" />' . "\n";
                }
            }
