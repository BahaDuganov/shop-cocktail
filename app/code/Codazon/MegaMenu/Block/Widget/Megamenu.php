...
class Megamenu extends Template implements \Magento\Widget\Block\BlockInterface
{
	...
	public function getIcon($content){
		...
		// 	return ($content->icon_font)?'<i class="menu-icon 123 fa fa-'.$content->icon_font.'"></i>':'';	
		// }else{
		// 	return ($content->icon_img)?'<i class="menu-icon 123 img-icon"><img src="'.$content->icon_img.'"></i>':'';	
		// }

		if(isset($content->icon_type) && $content->icon_type == 0){
			return ($content->icon_font)?'<i class="menu-icon '.$content->icon_font.'"></i>':'';	
		}else{
