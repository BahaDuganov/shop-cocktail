...
class ProcessOrderPlaceTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testExecute($giftCards, $giftCardsAmount, $accountRepoCount)
    {
        ...
        $address = $this->createPartialMock(
            ...
            ['getAmGiftCardsAmount', 'getBaseAmGiftCardsAmount', 'getAmGiftCards']
        );
        $address->expects($this->any())->method('getAmGiftCards')->willReturn($giftCards);
        $address->expects($this->any())->method('getBaseAmGiftCardsAmount')->willReturn($giftCardsAmount);
        $address->expects($this->any())->method('getAmGiftCardsAmount')->willReturn($giftCardsAmount);
        ...
        $this->accountRepository->expects($this->exactly($accountRepoCount))->method('getById')->willReturn($account);
        $this->accountRepository->expects($this->exactly($accountRepoCount))->method('save')->with($account);
